...
export interface ApiBarBar extends Schema.CollectionType {
  ...
  attributes: {
    id_bar: Attribute.UID;
    responsable: Attribute.Integer;
    ...
    >;
    total_sell: Attribute.Decimal;
    sell: Attribute.Decimal;
    own_expense: Attribute.Decimal;
    cash_payment: Attribute.Decimal;
    ...
    createdBy: Attribute.Relation<'api::bar.bar', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::bar.bar', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiDepositDeposit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    id_deposit: Attribute.UID;
    date: Attribute.DateTime;
    type: Attribute.Enumeration<['dataphone', 'cash', 'spend']>;
    bar: Attribute.Relation<'api::deposit.deposit', 'oneToOne', 'api::bar.bar'>;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    id_event: Attribute.UID;
    name: Attribute.String;
    date: Attribute.DateTime;
    pulep: Attribute.String;
...
export interface ApiProductStoreProductStore extends Schema.CollectionType {
  ...
  attributes: {
    id_product_store: Attribute.UID;
    event_price: Attribute.Decimal;
    public_price: Attribute.Decimal;
    bar_price: Attribute.Decimal;
    quantity_initial: Attribute.Integer;
    quantity: Attribute.Integer;
    return: Attribute.Integer;
    utility_quantity: Attribute.Decimal;
...
export interface ApiProductStoreSupplierProductStoreSupplier
  extends Schema.CollectionType {
  collectionName: 'product_store_suppliers';
  info: {
  ...
  attributes: {
    ...
    product_store: Attribute.Relation<
      'api::product-store-supplier.product-store-supplier',
      'oneToOne',
      'api::product-store.product-store'
    >;
...
export interface ApiRechargeProductRechargeProduct
  extends Schema.CollectionType {
  collectionName: 'recharge_products';
  info: {
    singularName: 'recharge-product';
    pluralName: 'recharge-products';
    displayName: 'Recharge_Product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    quantity: Attribute.Integer;
    product_store: Attribute.Relation<
      'api::recharge-product.recharge-product',
      'oneToOne',
      'api::product-store.product-store'
    >;
    recharge: Attribute.Relation<
      'api::recharge-product.recharge-product',
      'oneToOne',
      'api::recharge.recharge'
    >;
...
export interface ApiStoreStore extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dataphone: Attribute.Decimal;
    vouchers: Attribute.Decimal;
    suppplier_payment: Attribute.Decimal;
    utility: Attribute.Decimal;
...
export interface ApiSupplierSupplier extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    type: Attribute.Enumeration<['principal', 'revendedor']> &
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-store-supplier.product-store-supplier': ApiProductStoreSupplierProductStoreSupplier;
      'api::recharge.recharge': ApiRechargeRecharge;
      'api::recharge-product.recharge-product': ApiRechargeProductRechargeProduct;
